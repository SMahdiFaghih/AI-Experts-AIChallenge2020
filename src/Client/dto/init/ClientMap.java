...
public class ClientMap
{
    ...
    public Map castToMap()
    {
        ...
        map.setPaths(this.paths.stream().map(ClientPath::castToPath).collect(Collectors.toList()));
        map.setKings(this.kings.stream().map(ClientBaseKing::castToKing).collect(Collectors.toList()));
